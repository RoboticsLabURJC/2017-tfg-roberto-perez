...
(function(module, require, exports)
{
    ...
    let jderobot = _ModuleRegistry.module("jderobot");

    jderobot.RGBPoint = class
    {
        constructor(x = 0.0, y = 0.0, z = 0.0, r = 0.0, g = 0.0, b = 0.0)
        {
            this.x = x;
            this.y = y;
            this.z = z;
    ...
    Slice.defineStruct(jderobot.RGBPoint, false, false);

    jderobot.Point = class
    {
    ...
    Slice.defineStruct(jderobot.Point, false, false);

    jderobot.Segment = class
    {
        constructor(fromPoint = new jderobot.Point(), toPoint = new jderobot.Point())
        {
        ...
        _write(ostr)
        {
            jderobot.Point.write(ostr, this.fromPoint);
            jderobot.Point.write(ostr, this.toPoint);
        }

        _read(istr)
        {
            this.fromPoint = jderobot.Point.read(istr, this.fromPoint);
            this.toPoint = jderobot.Point.read(istr, this.toPoint);
        }
    ...
    Slice.defineStruct(jderobot.Segment, false, false);
    ...
    {
        "drawPoint": [, , , , [jderobot.RGBPoint], [[jderobot.RGBPoint]], , , , ],
        "drawSegment": [, , , , , [[jderobot.Segment], [jderobot.Color]], , , , ],
        "drawPoint2": [, , , , , [[jderobot.Point], [jderobot.Color]], , , , ],
        "clearAll": [, , , , , , , , , ]
    });
